    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/' }">{{ goodDetail.categories?.[1].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/' }">{{ goodDetail.categories?.[0].name }}
          </el-breadcrumb-item>
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <Images :imageList="goodDetail.mainPictures"></Images>
              <!-- 统计数量 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="(item, key) in goodDetail.details?.pictures" :key="key" :src="item">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
